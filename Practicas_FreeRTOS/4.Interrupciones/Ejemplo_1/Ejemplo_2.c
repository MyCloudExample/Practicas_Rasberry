/*Ejemplo 2C: En este ejemplo se utiliza una cola para cargar datos y que luego sea leida por la tarea task_lectora*/
#include <stdio.h>
...
{   datos_t recopila;
    ...
    while(true)
    {
        xQueuePeek(queue_recolectora, &recopila, portMAX_DELAY);
