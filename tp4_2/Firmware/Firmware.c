...
{ char msg1[30], msg2[30];
  ...
  pwm_config_set_clkdiv(&config, 10.0f); // Divisor de clock = 10 (para wrap manejable)
  pwm_config_set_wrap(&config, 12499);   // wrap = 12499 (1 kHz)
